...
tests_sha256: "918874091b15d87f4f7b97797762af80951f56d8a22e43982497d8462455f36d"
...
- `GATE_SPECS` — dict `{tool_name: {'script','params','defaults'}}` para
  los 13 gates: `validate_contracts`, `validate_specs`, `validate_okf`,
...
- `run_all_level1(repo_root='.') -> {'overall_ok': bool, 'results':
  {tool_name: {...}}}` — corre los 12 gates de Nivel 1 (todo
...
- `run_all_level1(repo_root='.')` sobre un repo con contratos rotos/faltantes
  -> `overall_ok: False`, 12 entradas en `results` (ver nota de RECON abajo
