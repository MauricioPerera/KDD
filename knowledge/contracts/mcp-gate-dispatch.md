...
tests_sha256: "81083f017700700399df41b32d08bcdb5e9a7a8a7b3cfc0da97179b642415d10"
...
- `GATE_SPECS` — dict `{tool_name: {'script','params','defaults'}}` para
  los 17 gates: `validate_contracts`, `validate_specs`, `validate_okf`,
...
- `run_all_level1(repo_root='.') -> {'overall_ok': bool, 'results':
  {tool_name: {...}}}` — corre los 16 gates de Nivel 1 (todo
...
- `run_all_level1(repo_root='.')` sobre un repo con contratos rotos/faltantes
  -> `overall_ok: False`, 16 entradas en `results` (ver nota de RECON abajo
