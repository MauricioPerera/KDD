...
tests_sha256: "07b5f72d7bcbde6976172e100e4720fa11b75bd1f94509de23c5ac193b219e38"
...
- `GATE_SPECS` — dict `{tool_name: {'script','params','defaults'}}` para
  los 14 gates: `validate_contracts`, `validate_specs`, `validate_okf`,
  ...
  `validate_compliance_findings`, `validate_test_commands`, `scan_secrets`,
...
- `run_all_level1(repo_root='.') -> {'overall_ok': bool, 'results':
  {tool_name: {...}}}` — corre los 13 gates de Nivel 1 (todo
...
- `run_all_level1(repo_root='.')` sobre un repo con contratos rotos/faltantes
  -> `overall_ok: False`, 13 entradas en `results` (ver nota de RECON abajo
