...
class RunBehaviorTests(unittest.TestCase):
    ...
    def _execute(self):
        return run_behavior.execute(self.root, self.contract, self.adapters,
                                    contract_sha256=run_behavior._hash(self.contract),
                                    adapters_sha256=run_behavior._hash(self.adapters))
